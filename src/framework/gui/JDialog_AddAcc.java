...
public class JDialog_AddAcc extends javax.swing.JDialog
{
	...
	public JDialog_AddAcc(Finco parent)
	{
		super(parent);
		parentframe=parent;
		...
		setSize(283,303);
		setVisible(false);
		JRadioButton_Chk.setText("Basic");
		JRadioButton_Chk.setActionCommand("Basic");
...
//           parentframe.accountType="S";
		...
		if(requiredJTextFields(listFields)){
			...
			if(user != null){
				...
				JOptionPane.showMessageDialog(parentframe, "Ooops.... User Creation Failed");
			}

		}
		else {
			JOptionPane.showMessageDialog(parentframe, "Missing Field(s)!!!");
			return;
		}
       dispose();
	}
	...
	public boolean requiredJTextFields(ArrayList<JTextField> requiredTextFields){
